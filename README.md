...
[Homebrew](https://github.com/Homebrew/brew) on macOS for installing ependencies.
This tool might work with Homebrew on Linux but is unsupported so don't file Linux issues.
